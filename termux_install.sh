...
echo "╠═══════════════════════════════════════════════════════════════╣"
echo "║  Author: Priyo.app Team                                       ║"
echo "║  Telegram: https://t.me/silent_sufferer                               ║"
...
echo -e "${YELLOW}•${NC} Telegram Channel: ${CYAN}https://t.me/silent_sufferer${NC}"
...
echo -e "${CYAN}Made with ❤️  by Priyo.app Team${NC}"
echo ""
