...
print('''
\033[1;92m Recoded By PARAN360
PARAN_BOSS
Telegram:https://t.me/paran360
One line Command: \nsudo python wifihack.py -i wlan0 -K\n
For Help Type: \npython wifihack.py --help\033[0m
''')
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.paran/sessions/'
        self.pixiewps_dir = f'{user_home}/.paran/pixiewps/'
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, modded by paran_B@B@
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by paran_B@B@',
